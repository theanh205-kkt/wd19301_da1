                                ...
                                <?php foreach ($listSanPham as $sanPham): ?>
                                    <div class="single-slide slick-slide">
                                        <div class="main-slider-content">
                                            <span class="subtitle"><i class="fal fa-watch"></i> Sách</span>
                                            <h1 class="title"><?= $sanPham['ten_san_pham'] ?></h1>
                                            <div class="shop-btn">
                                                <a href="#" class="axil-btn">Shop Now <i class="fal fa-long-arrow-right"></i></a>
                                            </div>
                                        </div>
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <div class="product-price-variant">
                                            <?php if ($sanPham['gia_khuyen_mai'] > 0): ?>
                                                <span class="price current-price"><?= formatPrice($sanPham['gia_khuyen_mai']) . 'đ'; ?></span>
                                                <span class="price old-price"><del><?= formatPrice($sanPham['gia_san_pham']) . 'đ'; ?></del></span>
                                            <?php else: ?>
                                                <span class="price current-price"><?= formatPrice($sanPham['gia_san_pham']) . 'đ' ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="axil-product product-style-four">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <div class="product-price-variant">
                                            <?php if ($topSp['gia_khuyen_mai'] > 0): ?>
                                                <span class="price current-price"><?= formatPrice($topSp['gia_khuyen_mai']) . 'đ'; ?></span>
                                                <span class="price old-price"><del><?= formatPrice($topSp['gia_san_pham']) . 'đ'; ?></del></span>
                                            <?php else: ?>
                                                <span class="price current-price"><?= formatPrice($topSp['gia_san_pham']) . 'đ' ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
